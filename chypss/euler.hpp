...
static constexpr int num_equation = 4;
...
class RiemannSolver {
 ...
 public:
  RiemannSolver();
  double Eval(const Vector& state1, const Vector& state2, const Vector& nor,
              Vector& flux);
};
...
FE_Evolution::FE_Evolution(FiniteElementSpace& _vfes, Operator& _A,
                           SparseMatrix& _Aflux)
...
RiemannSolver::RiemannSolver() : flux1(num_equation), flux2(num_equation) {}
