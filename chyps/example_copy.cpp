...
int main(int argc, char* argv[]) {
  ...
  ess_bdr = 0;
  ess_bdr[0] = 1;  // bottom wall for inline-quad.mesh
  ess_bdr[2] = 1;  // top wall for inline-quad.mesh
...
void ConductionOperator::ImplicitSolve(const double dt, const Vector& u,
  ...
  std::cout << "Should not see " << std::endl;
  ...
  M->FormLinearSystem(ess_tdof_list, tmp_du_dt, tmp_z, A, X, B);
